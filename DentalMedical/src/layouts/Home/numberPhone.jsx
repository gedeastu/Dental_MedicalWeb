...
const NumberInput = () => {
  return (
    ...
    <h1 className='font-generalSans font-semibold text-4xl leading-tight'>We’re <span className='relative'>Welcoming
      <svg className={'absolute w-full font-bold left-0 md:w-full md:right-0'} viewBox="0 0 533 10" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <p className='font-generalSans font-thin text-xl'>We use only the best quality materials on the
    <br /> 
    market in order to provide the best products 
    <br />
    to our patients, So don’t worry about anything 
    <br />
    and book yourself.</p>
    <div id='inputForm' className='flex flex-row items-center'>
    <input id='inputNumber' type="number" className='w-full h-[3.5rem] border-y-2 border-l-2 text-[#1376F8] text- rounded-tl-lg rounded-bl-lg placeholder:flex placeholder:items-center'
    ...
    <div id="image" className='w-[100%] h-[30rem]'>
      <img src={dentistPatient} alt="" className='rounded-xl object-cover w-full h-full'/>
    </div>
    </div>
    </article>
    </>
