    ...
    <>
     <div className='w-full h-full relative px-5 pt-16 pb-10 bg-[#E6F6FE] flex flex-col justify-between my-28 rounded-2xl md:items-center'>
      <div id="title" className='flex flex-col gap-4 md:items-center'>
        ...
        <svg className={'absolute w-44 right-0 -z-20 font-bold md:w-full md:bottom-0'} viewBox="0 0 533 10" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      style={
        'hidden md:flex md:flex-row md:items-center md:justify-center md:gap-10 md:w-full md:h-full md:p-4 md:pb-20'
      }
      buttonNext={
        <div className='bg-white h-full w-36 p-2 flex transition-all items-center group hover:bg-[#1376F8]'>
