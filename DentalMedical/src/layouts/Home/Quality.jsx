...
const Quality = () => {
  return (
    ...
    <h1 className='font-generalSans text-[2.5rem] font-semibold leading-tight w-[27rem] md:w-[40rem] md:text-5xl md:leading-snug'>Leave Your Worries At The Door And Enjoy A <span className='relative z-20'>Healthier
      ...
      </svg></span>, More Precise Smile</h1>
